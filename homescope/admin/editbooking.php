                            ...
                            <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                                ...
                                <div class="card-body p-4 p-sm-5">
                                    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                                        ...
                                        <h1 class="mb-3">Update Rent Request</h1>
                                    </div>
                                    ...
                                    <form
                                        action="includes/bookingHandler.php?bid=<?php echo htmlentities(intval($_GET['bid']));?>"
                                        method="post">

                                        <?php 
                                            $bid=intval($_GET['bid']);
                                            $sql = "SELECT p.*, u.name as uname, b.date, b.time, b.message, b.status from properties p, booking b, users u where b.id=$bid and b.uid=u.id and b.pid=p.id";
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="name"
                                                ...
                                                value="<?php echo htmlentities($result->uname);?>" disabled>
                                            <label for="floatingInputUsername">Client Name</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="name"
                                                id="floatingInputUsername"
                                                value="<?php echo htmlentities($result->name);?>" disabled>
                                            <label for="floatingInputUsername">Property Name</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" name="price"
                                                id="floatingInputEmail"
                                                value="<?php echo htmlentities($result->price);?>" disabled>
                                            <label for="floatingInputEmail">Rent Price</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="date" class="form-control" name="date"
                                                id="floatingInputUsername" value="<?php echo htmlentities($result->date);?>" required>
                                            <label for="floatingInputUsername">Booking Date</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="time"
                                                id="floatingInputEmail" value="<?php echo htmlentities($result->time);?>" required>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="message"
                                                id="floatingInputEmail"
                                                value="<?php echo htmlentities($result->message);?>" disabled>
                                        ...
                                        <div class="form-floating mb-3">
                                            <select class="form-control" name="status" id="floatingInputEmail" required enabled>
                                            ...
                                            </select> <label for="floatingInputEmail">Status</label>
                                        </div>
