...
<body>
    ...
    <div class="container-xxl bg-white p-0 overflow-hidden">
        ...
        ?>
                            <form action="includes/registerHandler.php" method="post" autocomplete="off">
                                ...
                                <div class="d-grid mb-2">
                                    <button class="btn btn-primary fw-bold text-uppercase mb-3"
                                            name="register" id="register" type="submit">Register</button>
                                    <a class="btn btn-primary fw-bold text-uppercase" href="sign-up-landlord.php">Register as a Landloard</a>
                                </div>
                            </form>
                        </div>
                    </div>
